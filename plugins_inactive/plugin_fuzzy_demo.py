...
def predict(core:VACore, command:str, context:dict): # на входе - команда + текущий контекст в формате Катюшы
    ...
    for k in context.keys():
        if str(k).find("таймер") != -1:
            ...
            # Тут возвращаем остаток фразы, чтобы Катюша переспросила про таймер
