...
def start(core:VACore):
    manifest = {
        ...
        "options_label": {
            ...
            "ttsEngineId2": "ID дополнительного движка озвучки. Всегда озвучивает результат на той машине, где запущена Катюша (без веб-интерфейса)",  # двиг для прямой озвучки на сервере. Если пуст - используется ttsEngineId
            ...
            "contextDefaultDuration": "Время в секундах, пока Катюша находится в контексте (контекст используется в непрерывном чате, играх и пр.; в контексте не надо использовать слово Катюша)",
        ...
        "default_options": {
            ...
            "voiceAssNames": "Катюша|Катюшы|Катюшу",
