...
def start(core:VACore):
    manifest = { # возвращаем настройки плагина - словарь
        "name": "НалогНаПрибыль", # имя
        "version": "1.0", # версия
        "require_online": False, # требует ли онлайн?

        "description": "Q3 Какой налог на прибыль в России для бизнеса\n"
                       "Налог",

        "commands": { # набор скиллов. Фразы скилла разделены | . Если найдены - вызывается функция
            "какой налог на прибыль в россии для бизнеса|налог на прибыль в россии для бизнеса": play_greetings,
        }
    }
    return manifest
...
def play_greetings(core:VACore, phrase: str): # в phrase находится остаток фразы после названия скилла,
    ...
    greetings = [
        "В России налог на прибыль для бизнеса составляет двадцать процентов от чистой прибыли. Однако, существуют некоторые льготы и особенности налогообложения в зависимости от вида деятельности и размера дохода. Также, для некоммерческих организаций и индивидуальных предпринимателей действуют отдельные налоговые ставки.",
    ]
